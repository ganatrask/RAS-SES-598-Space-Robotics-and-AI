...
setup(
    ...
    data_files=[
        ...
        ('lib/' + package_name, [
            ...
            'terrain_mapping_drone_control/cylinder_detector.py',
            'terrain_mapping_drone_control/cylinder_landing_controller.py',
    ...
    entry_points={
        'console_scripts': [
            ...
            'cylinder_detector = terrain_mapping_drone_control.cylinder_detector:main',
            'cylinder_landing_controller = terrain_mapping_drone_control.cylinder_landing_controller:main',
        ],
    },
    python_requires='>=3.8'
) 